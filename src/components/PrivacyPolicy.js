...
const PrivacyPolicy = () => {
  return (
    ...
    <main className="__className_656221">
      ...
      <div className="max-w-md mx-auto px-3 py-3 sm:px-3 lg:px-3 lg: md: leading-10">
        <div>
          <p className="text-[1em] font-bold">Privacy Policy for Habuild Healthtech Pvt. Ltd.</p>
        </div>
        <div className="mt-[2em]">
          <p className>At Habuild, accessible from habuild.in, one of our main priorities
            is the privacy of our visitors. This Privacy Policy document
            contains types of information that is collected and recorded by
            Habuild and how we use it. If you have additional questions or
            require more information about our Privacy Policy, do not hesitate
            to contact us.</p>
          <p className="mt-[1em]">This Privacy Policy applies only to our online activities and is
            valid for visitors to our website with regards to the information
            that they shared and/or collect in Habuild. This policy is not
            ...
            emails Find and prevent fraud Log Files Habuild follows a standard
            ...
            information. Cookies and Web Beacons Like any other website, Habuild
          ...
          <p className="mt-[1em]">Advertising Partners Privacy Policies You may consult this list to
            find the Privacy Policy for each of the advertising partners of
            Habuild. Third-party ad servers or ad networks uses technologies
            like cookies, JavaScript, or Web Beacons that are used in their
            respective advertisements and links that appear on Habuild, which
            ...
            you visit. Note that Habuild has no access to or control over these
            cookies that are used by third-party advertisers. Third Party
            Privacy Policies Habuild's Privacy Policy does not apply to other
            ...
            that a business that collects a consumer's personal data disclose
            ...
            online activity. Habuild does not knowingly collect any Personal
